...
get_header(); ?>
    ...
    <section class="home-section home-fade home-full-height bg-dark-60 landing-header" id="home" data-background="http://www.onlineschools.org/wp-content/uploads/2013/12/online-college-header.jpg">
        <div class="titan-caption">
            <div class="caption-content">
                <div class="container">
                    ...
                    <div class="font-alt mt-30"><a class="btn btn-border-w btn-circle" href="#"><i class="icon icon-download"></i> Download App</a></div>
                </div>
            </div>
        </div>
    </section>
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2"><img class="img-responsive banner-img" src="http://www.onlineschools.org/wp-content/uploads/2013/12/online-college-header.jpg"></div>
        </div>
    </div>
    <div class="main">
        ...
        <section class="module pb-0 bg-dark landing-reason parallax-bg" data-background="wp-content/uploads/2018/02/why_choose_bg.png">
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                        <div class="alt-services-image align-center"><img src="wp-content/uploads/2018/02/landing/feature.png" alt="Feature Image"></div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="alt-features-item">
        ...
        <section>
            <div class="container">
                <div class="row landing-image-text">
                    <div class="col-sm-6 col-sm-push-6"><img class="center-block" src="wp-content/uploads/2018/02/ipad.png" alt=""></div>
                ...
                <div class="row landing-image-text">
                    <div class="col-sm-6"><img class="center-block" src="wp-content/uploads/2018/02/iphone-mockup.png" alt=""></div>
                    <div class="col-sm-6">
        ...
        <section class="module bg-dark parallax-bg landing-screenshot" data-background="wp-content/uploads/2018/02/screenshot_bg.png">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="row client">
                    <div class="owl-carousel text-center" data-items="4" data-pagination="true" data-navigation="false">
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot1.jpg" alt="App Screenshot"></div>
                        </div>
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot2.jpg" alt="App Screenshot"></div>
                        </div>
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot3.jpg" alt="App Screenshot"></div>
                        </div>
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot4.jpg" alt="App Screenshot"></div>
                        </div>
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot5.jpg" alt="App Screenshot"></div>
                        </div>
                        <div class="owl-item">
                            <div class="col-sm-12"><img src="wp-content/uploads/2018/02/screenshot6.jpg" alt="App Screenshot"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <p class="module-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodoconsequat.</p><a href="#"><img class="image-button" src="assets/images/landing/apple-store-icon.png"></a><a href="#"><img class="image-button" src="wp-content/uploads/2018/02/landing/playstore-icon.png"></a><a href="#"><img class="image-button" src="assets/images/landing/windows-store-icon.png"></a>
                    </div>
                </div><img src="wp-content/uploads/2018/02/landscap-mockup.jpg">
            </div>
        </section>
